...
# -------------------------------------------------------------------------------------------------------------------
# Plots impact coefficiencts, also calculates and maps total impacts over time
# -------------------------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------
# Coal Off Mortality Impacts - Main Manuscript Figure 3
...
png(file="Plots/Fig3a.png",width=10,height=10,res=300,units="in")
...
# -------------------------------------------------------
# Coal Off Instrumented Mortality Impacts (Figure ED7)
...
png(file="Plots/FigED7.png",width=10,height=10,res=300,units="in")
  par(mar=c(5,6,2,1),las=1)
...
# -------------------------------------------------------
# Coal Off Crop Impacts (Main Manuscript Figure 3)
# Reduced form - both around plant and county level
# -------------------------------------------------------
...
png(file="Plots/Fig3b.png",width=10,height=4,res=300,units="in")
...
# -------------------------------------------------------
# Coal Off Instrumented Crop Impacts (Figure ED7)
# PM - both around plant and county level
# -------------------------------------------------------
...
png(file="Plots/FigED7b.png",width=10,height=4,res=300,units="in")
...
# -----------------------------------------------------------------------
# County Benefit Calculations/Maps (Main Manuscript Figure 3, Figure ED9)
# -----------------------------------------------------------------------

# Models to run - 25km and 200km
ind = c(11,14)
...
for (i in 1:length(ind)) {
  ...
  # Write out impact tables by county for reference
  countyimpacts=merge(countyimpacts,countycropimpacts,by="OBJECTID")
  countyimpacts=merge(countyimpacts,countycroploss,by="OBJECTID")
  write.csv(countyimpacts@data,file=paste("Analysis/County Impacts ",varoff,".csv",sep=""))
  
  # Fill Small Tables with Totals
  ...
  # Plots
  png(width=13,height=10,units="in",res=300,file=paste("Plots/LivesSaved_",vartot,".png",sep=""),type="cairo")
  ...
  png(width=13,height=10,units="in",res=300,file=paste("Plots/LivesLost_",vartot,".png",sep=""),type="cairo")
    mybks = c(1,20,50,100,200,500,2500)
  ...
  png(width=13,height=10,units="in",res=300,file=paste("Plots/CropsSaved_",vartot,".png",sep=""),type="cairo")
  ...
  png(width=13,height=10,units="in",res=300,file=paste("Plots/CropsLost_",vartot,".png",sep=""),type="cairo")
