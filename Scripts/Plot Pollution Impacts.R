...
if (load.pollution.data == TRUE) {
  ...
  # Load results sets (hold coefficients)
...
# -----------------------------------------------------------------------
# PM2.5 Tau Plots (Main Manuscript Figure 2a)
# -----------------------------------------------------------------------

ylims = pmylims = c(-1,1)
nudge = 0.05

png(file="Plots/Fig2a.png",width=10,height=6,res=300,units="in")
...
# -----------------------------------------------------------------------
# O3 Surf Tau Plots (Figure ED4)
# -----------------------------------------------------------------------

ylims = c(-2,2)

png(file="Plots/FigED4b.png",width=10,height=6,res=300,units="in")
  par(mar=c(5,8,1,1),las=1)
...
# -----------------------------------------------------------------------
# SO2 PBL Tau Plots (Figure ED4)
# -----------------------------------------------------------------------

ylims = c(-0.05,0.05)

png(file="Plots/FigED4d.png",width=10,height=6,res=300,units="in")
  par(mar=c(5,8,1,1),las=1)
  plot(-10,-10,xlim=c(-nyears,nyears-1),ylim=ylims,xlab="Leads / Lags [years]",ylab="",cex.lab=2,cex.axis=2)
...
# -----------------------------------------------------------------------
# NO2 Tau Plots (Figure ED4)
# -----------------------------------------------------------------------

ylims = c(-100,100)

png(file="Plots/FigED4f.png",width=10,height=6,res=300,units="in")
  par(mar=c(5,8,1,1),las=1)
  plot(-10,-10,xlim=c(-nyears,nyears-1),ylim=ylims,xlab="Leads / Lags [years]",ylab="",cex.lab=2,cex.axis=2)
...
# -----------------------------------------------------------------------
# Distance Plots (Main Manuscript Figure 2 and Figure ED4)
# -----------------------------------------------------------------------
...
# PM over distance
png(width=6,height=6,pointsize=12,file="Plots/Fig2b.png",res=300,units="in")
...
# O3 over distance
png(width=8,height=6,units="in",res=300,pointsize=12,file="Plots/FigED4a.png",type="cairo")
  par(mar=c(6,8,1,1),las=1)
...
# SO2 over distance
png(width=8,height=6,units="in",res=300,pointsize=12,file="Plots/FigED4c.png",type="cairo")
  par(mar=c(6,8,1,1),las=1)
...
# NO2 over distance
png(width=8,height=6,units="in",res=300,pointsize=12,file="Plots/FigED4e.png",type="cairo")
  par(mar=c(6,8,1,1),las=1)
...
# -----------------------------------------------------------------------
# Coefficients Plots (Main Manuscript Figure 2 and Figure ED5)
# -----------------------------------------------------------------------
...
png(width=10,height=6,units="in",res=300,file="Plots/Fig2c.png")
...
png(width=10,height=6,units="in",res=300,file="Plots/FigED5.png")
  par(mar=c(6,15,1,1),las=1)
  xx=seq(-1.2,1.2,0.2)  
  yy=rev(1:(dim(m)[1]))
  plot(xx,xx-100,ylim=c(0.5,max(yy)+2+0.5),yaxt="n",ylab="",xlab="",cex.axis=1.5,cex.lab=2)
