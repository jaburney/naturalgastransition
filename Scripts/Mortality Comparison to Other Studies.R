...
# -------------------------------------------------------------------------------------------------------------------
# Plots mortality coefficient comparisons
# -------------------------------------------------------------------------------------------------------------------
...
# Convert to per ug/m3 - GBD GEMM taken from steepest part of curve (US-ranges)
...
png(width=12,height=8,unit="in",res=300,file="Plots/FigED10.png")
