...
stargazer(m_tot_1[[1]],m_tot_1[[2]],m_tot_1[[3]],
          ...
          out="County_NCoal25.tex",type="latex",style="default",float=T,float.env="table",font.size="tiny",keep.stat=c("n","adj.rsq"),
...
stargazer(m_tot_4[[1]],m_tot_4[[2]],m_tot_4[[3]],
          ...
          out="County_NCoal200.tex",type="latex",style="default",float=T,float.env="table",font.size="tiny",keep.stat=c("n","adj.rsq"),
          out.header=T,dep.var.caption="Number of Coal-Fired Units within 200km of County",
          notes=c("All models include county and year fixed effects, with standard errors clustered at the county level."),
          notes.align="l"
)

stargazer(m_tot_5[[1]],m_tot_5[[2]],m_tot_5[[3]],
          m15[[1]],m.ivpm.15[[1]],m.ivpmsurf.15[[1]],
          m15[[15]],m.ivpm.15[[15]],m.ivpmsurf.15[[15]],
          m15[[16]],m.ivpm.15[[16]],m.ivpmsurf.15[[16]],
          m15[[17]],m.ivpm.15[[17]],m.ivpmsurf.15[[17]],
          out="County_NNG25.tex",type="latex",style="default",float=T,float.env="table",font.size="tiny",keep.stat=c("n","adj.rsq"),
          out.header=T,dep.var.caption="Number of Natural Gas-Fired Units within 25km of County",
          notes=c("All models include county and year fixed effects, with standard errors clustered at the county level."),
          notes.align="l"
)
...
stargazer(m_tot_12[[1]],m_tot_12[[2]],m_tot_12[[3]],
          ...
          out="County_NCoalandNG200.tex",type="latex",style="default",float=T,float.env="table",font.size="tiny",keep.stat=c("n","adj.rsq"),
